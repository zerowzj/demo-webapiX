 ...
 */
@Component
public class Action_get_got_list extends BaseAction {
    ...
    public Map<String, Object> execute(RequestContext cxt, Map<String, Object> params) {
        PageList<PackageBaseEO> pbEOLt = packageService.getPackagePageLt(cxt.getUbId(), null, "G", null, null, page_no, page_size);
